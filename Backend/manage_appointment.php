...
$appointmentsQuery = "SELECT * FROM appointments WHERE name = '$username'"; //------ manage appointment
$appointmentsResult = mysqli_query($conn, $appointmentsQuery);

$labQuery = "SELECT * FROM lab_appointments WHERE name = '$username'"; //---------manage lab appointment
    ...
    <div class="container">
        ...
        <div class="sidebar">
            ...
            <li><a href="patient_portal.php" >Dashboard</a></li>
                ...
                <li><a href="manage_appointment.php" class="active">Manage Appointments</a></li>
        ...
        <!--------------------------------------Content -->
        <div class="content">
            <h1>Hello, <?php echo htmlspecialchars($username); ?>! Welcome to the Manage Appointmet</h1>
