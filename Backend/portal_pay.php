...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if (mysqli_num_rows($result) > 0) {
        ...
        header("Location: ../Backend/portal_payment.php?message=duplicate");
        exit();
    } else {
        // ----------------------------------------Insert details 
        ...
        if (mysqli_query($conn, $sql)) {
            ...
            header("Location: ../Backend/portal_payment.php?message=success");
            exit();
        } else {
      
            header("Location: ../Backend/portal_payment.php?message=error");
            exit();
        }
    }
} else {
